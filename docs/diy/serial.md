...
![UART](https://static.gl-inet.com/docs/en/2.x/diy/src/serial.jpg)
...
![Com](https://static.gl-inet.com/docs/en/2.x/diy/src/find-serial-port.png)
...
![Putty](https://static.gl-inet.com/docs/en/2.x/diy/src/putty.png)

You will be displayed a black window. If you turn on your device now, you will see the console output of the box.


![Putty](https://static.gl-inet.com/docs/en/2.x/diy/src/putty1.png)
