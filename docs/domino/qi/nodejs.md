...
![CRC error](https://static.gl-inet.com/docs/router/en/2/domino/qi/src/crc.jpg)

Now enter uboot and save envirment vairables. You need to use do this using serial as intructed [here](../serial/).

![Save env](https://static.gl-inet.com/docs/router/en/2/domino/qi/src/saveenv.jpg)
...
![LininoIO Stop](https://static.gl-inet.com/docs/router/en/2/domino/qi/src/lininoio-stop.png)

![LininoIO Stop](https://static.gl-inet.com/docs/router/en/2/domino/qi/src/lininoio-stop1.png)
...
![MCUIO](https://static.gl-inet.com/docs/router/en/2/domino/qi/src/mcuio.png)
