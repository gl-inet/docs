...
![tftp install](https://static.gl-inet.com/docs/router/en/2/dev/src/tftpd-install.png) 

Turn off windows firewall, which is the main reason causing tftpd failed to connect.

![tftp install](https://static.gl-inet.com/docs/router/en/2/dev/src/firewall.png) 
...
![tftp install](https://static.gl-inet.com/docs/router/en/2/dev/src/tftpd-status.png) 
...
![Uboot Web UI](https://static.gl-inet.com/docs/router/en/2/dev/src/uboot_failsafe.png)
